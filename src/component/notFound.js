    ...
    return (
        <div>
            <main className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
                ...
                <div className="bg-success px-2 text-black text-sm rounded rotate-12 absolute">
                    Page Not Found
                </div>
        ...
        ></span>
          ...
          <Link className="relative block px-8 py-3 bg-secondary border border-current" to="/">Go Home</Link>
        </span>
                    </a>
                </button>
            </main>
